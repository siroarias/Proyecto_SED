...
HD_PWD='C:/Users/SIRO/Desktop/repositorios_stm32/Proyecto_SED/carretera/carretera.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TrafficControl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TrafficControl.tcl -notrace
